...
To use this, you must put it as a .lua into your matcha folder, and require it. Example below:

Example:
	local TweenTest = require('TweenService')
	local box = {
	    Position = {x = 0, y = 0, z = 0}
	}
	local tweenInfo =  TweenTest.TweenInfo.new(5, "Linear", "Linear", 0, false, 0)
	
	
	
	local Tween = TweenTest:Create(box, tweenInfo, {
	...
	local Tween = TweenTest:Create(game.Players.LocalPlayer.Character.HumanoidRootPart, tweenInfo, {
